...
The **inner loop** is a different object: a [named reconstruction menu](/teaching/science-communication/ogts-architecture-menu/) pruned by throughput and resolution. That family tree does not live on this diagram. This page is only the outer loop, hypothesis space and allotment. A vertex-less radiative photon is a harder calorimeter object than an inclusive cluster; that fact conditions Λb → Λγ here.
